...
<template>
    <div id="app" class="min-w-300 min-h-[100vh] flex cursor-default">
        <div class="overtime-policy flex w-full max-w-7xl">
            ...
            <section
                class="content pt-[20px] px-[31px] pb-[37px] bg-white mt-[23px] rounded shadow border"
            >
                    ...
                    <template v-for="(group, index) in superAdminGroup" :key="index">
                        ...
                        >
                            <p class="truncate pr-4 w-full"
                                :class="[selectedGroup.cmsRoleGroupSeq===group.cmsRoleGroupSeq ? 'font-bold text-[16px] text-[#4361EE]':'mr-2']"
                            >
                                {{group.roleGroupName}}
                            </p>
