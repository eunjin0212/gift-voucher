    ...
    <div id="app" class="min-w-[1024px] min-h-[100vh] flex">
        ...
        <AppMain :headerName="registerData.companyName">
            <div class="flex justify-between max-w-7xl">
                ...
                <ElementsButton text="Back To List" :bgWhiteAndtextIndigo="true" :fitContent="true" @click="backToCompanyList" />
            </div>
        ...
        <Teleport to="body">
            <AdminPopUp :masterAdmin="masterAdmin" v-if="masterAdmin.isOpen" />
        </Teleport>
    </div>
</template>
...
export default {
    ...
    methods: {
        ...
        getCompanyData() {
            ...
            return self.$axios.get(`${url}/${subscriptionCompanySeq}`).then((res) => res.data.data);
        },
        getFlexbenType() {
            const self = this;
        ...
        getFlexbenHistoryList(companySeq) {
            ...
            self.$axios
                .get(url, { params: { json_query: JSON.stringify(json_query) } })
                .then((res) => {
