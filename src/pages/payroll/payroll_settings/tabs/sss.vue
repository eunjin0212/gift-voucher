        ...
        <div class="flex justify-between py-1">
            <div class="flex justify-start gap-5">
                ...
                <h1 class="text-zinc-800 text-xl font-semibold leading-10 items-center ">
                    {{isInsertMode(settingMode) ? "Update " : isEditMode(settingMode) ? "Edit" : "" }} SSS
                </h1>
            </div>
                    ...
                    <table class="relative min-w-full divide-y divide-gray-300 table-auto">
                        <thead class="sticky top-0 left-0 right-0 text-white" style="z-index: 1; background: #4031B8;">
                            <tr>
                                ...
                                <th scope="col" colspan="2" class="px-3 py-3 border border-solid border-white text-center text-sm">MONTHLY SALARY CREDIT</th>
                                <th scope="col" colspan="2" class="px-3 py-3 border border-solid border-white text-center text-sm">Regular SS</th>
                                <th scope="col" colspan="2" class="px-3 py-3 border border-solid border-white text-center text-sm">EC</th>
                                <th scope="col" colspan="2" class="px-3 py-3 border border-solid border-white text-center text-sm">WISP</th>
                            </tr>
                            <tr>
                                ...
                                <th scope="col" class="px-3 py-3 w-24 border-x border-solid border-white text-center text-sm">Regular SS / EC</th>
                                <th scope="col" class="px-3 py-3 w-24 border-x border-solid border-white text-center text-sm">Mandatory Provident Fund</th>
                                <th scope="col" class="px-3 py-3 w-24 border-x border-solid border-white text-center text-sm">ER</th>
                                <th scope="col" class="px-3 py-3 w-24 border-x border-solid border-white text-center text-sm">EE</th>
                                <th scope="col" class="px-3 py-3 w-24 border-x border-solid border-white text-center text-sm">ER</th>
                                <th scope="col" class="px-3 py-3 w-24 border-x border-solid border-white text-center text-sm">EE</th>
                                <th scope="col" class="px-3 py-3 w-24 border-x border-solid border-white text-center text-sm">ER</th>
                                <th scope="col" class="px-3 py-3 w-24 border-x border-solid border-white text-center text-sm">EE</th>
                        ...
                        <tbody class=" bg-white">
                            <tr v-for="(detail, index) in settingDetailViewList" v-bind:key="index" class="border-x border-y border-solid border-gray-200">
                                ...
                                <td class="px-3 py-3 border-x border-solid border-gray-200 text-center text-sm text-gray-900"><span>{{ fitDecimalFormatWithComma(detail.monthlySalaryCreditRegularSsAndEc) }}</span></td>
                                <td class="px-3 py-3 border-x border-solid border-gray-200 text-center text-sm text-gray-900"><span>{{ fitDecimalFormatWithComma(detail.monthlySalaryCreditMandatoryProvidentFund) }}</span></td>
                                <td class="px-3 py-3 border-x border-solid border-gray-200 text-center text-sm text-gray-900"><span>{{ fitDecimalFormatWithComma(detail.regularSsEr) }}</span></td>
                                <td class="px-3 py-3 border-x border-solid border-gray-200 text-center text-sm text-gray-900"><span>{{ fitDecimalFormatWithComma(detail.regularSsEe) }}</span></td>
                                <td class="px-3 py-3 border-x border-solid border-gray-200 text-center text-sm text-gray-900"><span>{{ fitDecimalFormatWithComma(detail.ecEr) }}</span></td>
                                <td class="px-3 py-3 border-x border-solid border-gray-200 text-center text-sm text-gray-900"><span>{{ fitDecimalFormatWithComma(detail.ecEe) }}</span></td>
                                <td class="px-3 py-3 border-x border-solid border-gray-200 text-center text-sm text-gray-900"><span>{{ fitDecimalFormatWithComma(detail.wispEr) }}</span></td>
                                <td class="px-3 py-3 border-x border-solid border-gray-200 text-center text-sm text-gray-900"><span>{{ fitDecimalFormatWithComma(detail.wispEe) }}</span></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
...
export default {
    ...
    methods : {
        ...
        changeAddSettingPage(){
            ...
            self.registerData.settingType = null;
        ...
        getPayrollSettingDetail(payrollSettingSeq, settingStatus) {
            ...
            .then(res => {
                ...
                self.settingDetail.sssFormList = detailData.settingDetailList;
        ...
        changeEditSettingPage() {
            ...
            self.updateData.excelFileLink = null;
            const tomorrow = moment().add(1, 'days').format();
            self.startDatetimeLowerLimit = tomorrow;
        ...
        updateSetting() {
            ...
            delete self.updateData.sssFormList;
