...
import App from "@/pages/payroll/payroll_settings/payroll_settings.vue";
import "@/index.css";
...
import ElementsFileNoImage from "@/components/elements/ElementsFileNoImage.vue";
...
initApp(createApp(App)).then((app) => 
	app
		...
		.component("ElementsFileNoImage", ElementsFileNoImage)
